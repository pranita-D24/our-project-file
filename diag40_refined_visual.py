...
def run_refined_hybrid_diag40():
    ...
    # Final Coordinates from diagnostic
    pad = 10
    added_boxes = [
        {"name": "NOTE", "x": 1452-pad, "y": 62-pad, "w": 960+2*pad, "h": 24+2*pad},
        {"name": "3D ISO", "x": 1321-pad, "y": 203-pad, "w": 270+2*pad, "h": 167+2*pad},
        {"name": "BOTTOM", "x": 1025-pad, "y": 1516-pad, "w": 321+2*pad, "h": 180+2*pad}
    ]
    ...
    for box in added_boxes:
        ...
        cv2.putText(analysis, "ADDED", (box["x"], box["y"]-15),
    ...
    h_labels = ["V1 (ORIGINAL)", "V2 (REVISION)", "ANALYSIS | ADDED: 3"]
    ...
    print(f"Refined Hybrid Report Saved: {output_path}")

if __name__ == '__main__':
    run_refined_hybrid_diag40()
